/** 首页产品能力与截图文件名（由 RacedCdnImage 竞速 JSDMirror / jsDelivr）。 */
...
export const HOME_SHOWCASE = [
  {
    ...
    imageFile: "deptmanage.png",
    imageAlt: "部门管理截图",
  },
  {
    title: "机构管理",
    description: "机构档案与管理员绑定，一站式开通租户环境。",
    imageFile: "orgmanage.png",
    imageAlt: "机构管理截图",
  },
  {
    title: "自定义字段",
    description: "列表字段可配置展示，贴合不同业务查看习惯。",
    imageFile: "customfields.png",
    imageAlt: "自定义字段截图",
  },
] as const;
